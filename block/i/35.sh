...
[g][o][e][a][s][t]) sed -i '/cell=/c\cell=24' status ; break ;;

[g][o][s][o][u][t][h]) sed -i '/cell=/c\cell=36' status ; break ;;

[g][o][w][e][s][t]) sed -i '/cell=/c\cell=34' status ; break ;;

[l][o][o][k]) output=$(./utils.sh blockform looki i35) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform lookdoor door1 door19 $i24 1) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform lookdoor corridor4 corridor5 $i36) ;;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform lookdoor corridor4 corridor5 $i34) ;;
...
[s][m][e][l][l][w][e][s][t][c][o][r][r][i][d][o][o][r]) output=$(./utils.sh blockform smell corridor3) ;;
