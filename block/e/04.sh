...
echo "$image"
if [ $i32bwindow -eq 1 ] ; then ./utils.sh overlay win1 23 1 0 ; fi
}
...
[l][o][o][k]) ouput=$(./utils.sh blockform elook 04) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east $e05 1) ;;
...
[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform elookdir west $e03 3) ;;
...
[s][m][e][l][l][h][e][d][g][e]) output=$(./utils blockform smell hedgee) ;;
