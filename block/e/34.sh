...
[g][o][e][a][s][t]) sed -i '/cell=/c\cell=35' status ; break ;;

[g][o][n][o][r][t][h]) output=$(./utils.sh blockform elooka hedge3) ;;

[g][o][s][o][u][t][h]) sed -i '/cell=/c\cell=27' status ; break ;;

[g][o][w][e][s][t]) sed -i '/cell=/c\cell=33' status ; break ;;

[l][o][o][k]) output=$(./utils.sh blockform elook 11) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east $e35 1) ;;

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform elookdir north 1 7) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform elookdir south $e27 4) ;;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform elookdir west $e33 1) ;;
