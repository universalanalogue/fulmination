...
[g][o][e][a][s][t]) sed -i '/cell=/c\cell=33' status ; break ;;
...
[l][o][o][k]) output=$(./utils.sh blockform elook 32) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east $e33 1) ;;

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform elookdir north 1 1) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform elookdir south $e25 1) ;;
...
if [ $book21 -eq 1 ]
then
output=$(./utils.sh blockform elooka rock1)
else
output=$(./utils.sh blockform elooka rock2)
fi ;;
