...
[g][o][n][o][r][t][h]) sed -i '/cell=/c\cell=18' status ; break ;;

[g][o][s][o][u][t][h]) sed -i '/cell=/c\cell=10' status ; break ;;

[g][o][w][e][s][t]) sed -i '/cell=/c\cell=13' status ; break ;;

[l][o][o][k]) output=$(./utils.sh blockform elook 14) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east $e15 9) ;; 

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform elookdir north $e18 1) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform elookdir south $e10 3) ;;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform elookdir west $e13 5) ;;
...
[l][i][c][k][f][o][r][e][s][t]) output=$(./utils.sh blockform uni lick) ;;
