...
[g][o][s][o][u][t][h]) sed -i '/cell=/c\cell=19' status ; break ;;

[g][o][w][e][s][t]) sed -i '/cell=/c\cell=22' status ; break ;;

[l][o][o][k]) output=$(./utils.sh blockform elook 23 wolf $wolf) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east 1 9) ;;

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform elookdir north $e30 10) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform elookdir south $e19 1) ;;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform elookdir east $e22 3) ;;
...
[l][o][o][k][s][h][e][d]) output=$(./utils.sh blockform elookdir north 1 10) ;;
