...
[l][o][o][k]) output=$(./utils.sh blockform looki i09 box3 $i9box box4 $i9box) ;;
...
output=$(./utils.sh blockform looki null box1 0 key2 $key4 book7 $book13)
fi ;;

[l][o][o][k][d][o][o][r]) output=$(./utils.sh blockform lookdoor door1 door4 $i03 1) ;;

[l][o][o][k][f][l][o][o][r]) output=$(./utils.sh blockform looki null floor3 0) ;;

[l][o][o][k][k][e][y]) if [ $i9box -eq 1 ] && [ $key4 -eq 0 ] || [ $key4 -eq 1 ]
then
./lib.sh key4a
output=$(./utils.sh blockform lookkey i09) 
else
output=$(./utils.sh blockform uni look)
fi ;;
...
intro=1
output=$(./utils.sh blockform looki null window10 0 window7 $i8awindow) ;;

[l][o][o][k][n][o][r][t][h][w][i][n][d][o][w]) sed -i '/focus=/c\focus=2' status
intro=1
output=$(./utils.sh blockform looki null window11 0 window7 $i5bwindow) ;;

[l][o][o][k][s][o][u][t][h][w][i][n][d][o][w]) sed -i '/focus=/c\focus=3' status
intro=1
output=$(./utils.sh blockform looki null window12 0 window7 $i1window) ;;

[l][o][o][k][w][a][l][l]) output=$(./utils.sh blockform looki null wall5 0) ;;

[o][p][e][n][b][o][x]) if [ $i9box -eq 1 ]
then
output=$(./utils.sh blockform looki null box8 0)
else
...
[l][i][c][k][b][o][x]) output=$(./utils.sh blockform lick box3) ;;

[l][i][c][k][d][o][o][r]) output=$(./utils.sh blockform lick door6) ;;
...
[l][i][c][k][w][a][l][l]) output=$(./utils.sh blockform lick door6) ;;
...
[s][m][e][l][l][b][o][x]) output=$(./utils.sh blockform smell box3) ;;
...
[s][m][e][l][l][w][a][l][l]) output=$(./utils.sh blockform smell wall2) ;;
...
[l][o][o][k]) output=$(./utils.sh blockform looki null window10 0 window7 $i8awindow) ;;

[l][o][o][k][d][o][o][r]) output=$(./utils.sh blockform looki null door28 0) ;;
...
[l][o][o][k][w][i][n][d][o][w]) output=$(./utils.sh blockform looki null window24 0 figure1 $book31 window7 $1window) ;;
...
[l][o][o][k]) output=$(./utils.sh blockform looki null window11 0 window7 $i5bwindow) ;;

[l][o][o][k][b][o][x]) output=$(./utils.sh blockform looki null box12 0) ;;
...
[l][o][o][k]) output=$(./utils.sh blockform looki null window12 0 window7 $i1window) ;;

[l][o][o][k][b][o][o][k]) if [ $book31 -eq 0 ]
then
output=$(./utils.sh blockform looki null book1 0)
else
output=$(./utils.sh blockform uni look)
fi ;;
...
output=$(./utils.sh blockform looki null table2 0)
fi ;;
