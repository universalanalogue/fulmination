...
[l][o][o][k]) output=$(./utils.sh blockform looki i34) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform lookdoor corridor4 corridor5 $i35) ;;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform lookdoor corridor4 corridor6 $i33) ;;
