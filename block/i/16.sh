...
[l][o][o][k]) output=$(./utils.sh blockform looki i16) ;;

[l][o][o][k][e][a][s][t][d][o][o][r])
output=$(./utils.sh blockform lookdoor door1 door8 $i15 1) ;;

[l][o][o][k][w][e][s][t][d][o][o][r]) 
output=$(./utils.sh blockform lookdoor door1 door8 $i17 1) ;;

[l][o][o][k][f][l][o][o][r]) output=$(./utils.sh blockform looki null floor5 0 sprocket1 $sprocket) ;;

[l][o][o][k][s][p][r][o][c][k][e][t]) if [ $sprocket -eq 0 ]
then
output=$(./utils.sh blockform looki null sprocket2 0)
