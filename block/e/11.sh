...
[g][o][n][o][r][t][h]) sed -i '/cell=/c\cell=15' status ; break ;;

[g][o][s][o][u][t][h]) sed -i '/cell=/c\cell=07' status ; break ;;

[g][o][w][e][s][t]) sed -i '/cell=/c\cell=10' status ; break ;;

[l][o][o][k]) output=$(./utils.sh blockform elook 11) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east 1 7) ;;

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform elookdir north $e15 1) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform elookdir south $e07 1) ;;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform elookdir west $e10 1) ;;
...
[l][i][c][k][r][o][c][k]) output=$(./util.sh blockform lick rock) ;;
