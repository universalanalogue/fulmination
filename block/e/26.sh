...
e25=$(grep 'e5=' status | cut -d "=" -f2)
e27=$(grep 'e10=' status | cut -d "=" -f2)
e33=$(grep 'e13=' status | cut -d "=" -f2)
...
[l][o][o][k]) output=$(./utils.sh blockform elook 26) ;;
 
[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east $e27 1) ;;

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform elookdir north $e33 2) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform elookdir south 1 4) ;;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform elookdir west $e25 1) ;;
