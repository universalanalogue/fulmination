...
i25=$(grep 'i25=' status | cut -d "=" -f2)
i26=$(grep 'i26=' status | cut -d "=" -f2)
...
[g][o][n][o][r][t][h]) sed -i '/cell=/c\cell=39' status ; break ;;

[g][o][s][o][u][t][h]) sed -i '/cell=/c\cell=41' status ; break ;;

[g][o][w][e][s][t]) sed -i '/cell=/c\cell=25' status ; break ;;

[l][o][o][k]) output=$(./utils.sh blockform looki i40) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform lookdoor door1 door20 $i23 1) ;;

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform lookdoor corridor4 corridor5 $i39) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform lookdoor corridor4 corridor7 $i41) ;;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform lookdoor door1 door20 $i22 1) ;;
