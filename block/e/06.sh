...
[g][o][e][a][s][t]) sed -i '/cell=/c\cell=07' status ; break ;;

[g][o][n][o][r][t][h]) sed -i '/cell=/c\cell=10' status ; break ;;

[g][o][s][o][u][t][h]) output=$(./utils.sh blockform elooka hedge3) ;;

[g][o][w][e][s][t]) sed -i '/cell=/c\cell=05' status ; break ;;

[l][o][o][k]) output=$(./utils.sh blockform elook 05) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east $e07 1) ;;

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform elookdir north $e10 3) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform elookdir south 1 2);;

[l][o][o][k][w][e][s][t]) output=$(./utils.sh blockform elookdir west $e05 1) ;;
