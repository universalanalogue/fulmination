...
[g][o][e][a][s][t]) sed -i '/cell=/c\cell=19' status ; break ;;

[g][o][n][o][r][t][h]) sed -i '/cell=/c\cell=22' status ; break ;;

[g][o][s][o][u][t][h]) sed -i '/cell=/c\cell=14' status ; break ;;

[g][o][w][e][s][t]) sed -i '/cell=/c\cell=17' status ; break ;;

[l][o][o][k]) output=$(./utils.sh blockform elook 18) ;;

[l][o][o][k][e][a][s][t]) output=$(./utils.sh blockform elookdir east $e19 1) ;;

[l][o][o][k][n][o][r][t][h]) output=$(./utils.sh blockform elookdir north $e22 3) ;;

[l][o][o][k][s][o][u][t][h]) output=$(./utils.sh blockform elookdir south $e14 1) ;;

[l][o][o][k][w][e][s][t])  output=$(./utils.sh blockform elookdir west $e17 3) ;;
